...
function EcoV1() {
  ...
  return (
    <div className="wf">
      ...
      {/* divider */}
      <div style={{ display: "flex", alignItems: "center", gap: 18, padding: "6px max(40px, 4vw)" }}>
        <div style={{ flex: 1, height: 1, background: "linear-gradient(90deg, transparent 0%, #b39ddb 35%, #7c3aed 100%)" }}></div>
        <svg width="68" height="24" viewBox="0 0 68 24"><line x1="0" y1="12" x2="22" y2="12" stroke="#7c3aed" strokeWidth="1" /><line x1="46" y1="12" x2="68" y2="12" stroke="#7c3aed" strokeWidth="1" /><circle cx="14" cy="12" r="2" fill="#b39ddb" /><circle cx="54" cy="12" r="2" fill="#b39ddb" /><circle cx="34" cy="12" r="4.5" fill="#7c3aed" /><circle cx="34" cy="12" r="2" fill="#fff" /></svg>
