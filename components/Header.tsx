...
export async function Header() {
  ...
  return (
    ...
    >
      <Link href="/" className="site-header__brand" style={{ display: "flex", alignItems: "center", gap: 11, textDecoration: "none", color: "inherit" }}>
        ...
        <span className="site-header__tag" style={{ fontFamily: "var(--mono)", fontSize: 10, color: "var(--violet-dark)", letterSpacing: ".18em", marginLeft: 8, fontWeight: 600 }}>
      ...
      <div className="site-header__end">
        {auth.loggedIn && auth.profile ? (
          ...
          <div className="navstrip-actions">
            ...
            <Link
              href="/signup"
              className="pill nav-pill solid nav-pill--compact-mobile"
