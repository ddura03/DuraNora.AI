    ...
    <div className="auth-stage">
      ...
      <form className="card" onSubmit={(e) => e.preventDefault()}>
        ...
        <label className="terms">
          ...
          <span className="box" />
          <span>I agree to the <a className="link">Terms of Service</a> and <a className="link">Privacy Policy</a>.</span>
        </label>

        <button className="btn" type="submit" onClick={() => { if (agree) window.location.href = "Learn AI Page Wireframes.html"; }} style={{ opacity: agree ? 1 : 0.55 }}>
