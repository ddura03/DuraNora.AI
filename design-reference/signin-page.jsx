  ...
  return (
    <div className="auth-stage">
      ...
      <form className="card" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="field">
          <input type={showPw ? "text" : "password"} placeholder="Password" autoComplete="current-password" />
        ...
        <div style={{ marginTop: 20, textAlign: "center" }}><a className="home-link" href="DuraNoia Wireframes.html"><span className="ar">←</span> Return to home</a></div>
      </form>
    </div>
  );
}
