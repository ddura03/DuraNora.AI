...
export const NEWS: NewsItem[] = [
  {
    ...
    cat: "Releases",
    date: "May 24, 2026",
    title: "GPT-6 multimodal preview opens to Plus tier",
    excerpt:
      "New voice + vision routing surfaces in the API with sub-200ms latency targets…",
  },
  {
    tag: "Anthropic",
    cat: "Releases",
  ...
  },
  {
    ...
    cat: "Funding",
    date: "May 17, 2026",
    title: "Grok 4 announces $6B Series D for compute",
  ...
  },
  {
    ...
    excerpt: "New paper claims frontier reasoning at a fraction of the GPU-hours used elsewhere…",
  },
  {
    tag: "EU",
    cat: "Policy",
    ...
    excerpt: "Transparency and disclosure rules land for anyone shipping models into Europe…",
  },
  {
    tag: "Perplexity",
    cat: "Funding",
...
export const NEWS_ITEMS: NewsItem[] = [
  {
    ...
    excerpt:
      "OpenAI's voice + vision routing now ships in the API with sub-200ms latency targets and a redesigned realtime endpoint. Here's what changed, what it costs, and which of your prompts to revisit.",
  },
  {
    id: "claude5-mem",
    company: "Anthropic",
...
export const NEWS_CATS = ["All", "Releases", "Funding", "Research", "Policy"] as const;
